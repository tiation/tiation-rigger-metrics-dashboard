---
layout: default
title: Tiation Rigger Metrics Dashboard - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Tiation Rigger Metrics Dashboard</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/tiation-rigger-metrics-dashboard" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t tiation-rigger-metrics-dashboard .

# Run container
docker run -p 8080:8080 tiation-rigger-metrics-dashboard
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/tiation-rigger-metrics-dashboard)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/tiation-rigger-metrics-dashboard/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/tiation-rigger-metrics-dashboard/discussions)
